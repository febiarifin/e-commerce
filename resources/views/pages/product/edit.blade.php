                        ...
                        <div class="row mb-3">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="status" class="form-control" required>
                                    ...
                                    <option value="active" {{ $product->status == \App\Models\Product::ACTIVE ? 'selected' : null }}>ACTIVE</option>
                                    <option value="inactive" {{ $product->status == \App\Models\Product::INACTIVE ? 'selected' : null }}>INACTIVE</option>
                                </select>
                            </div>
                            <div class="mb-3 col-md-12">
                                <label>Product Decription</label>
                                <input id="x" value="{{ $product->description }}" type="hidden" name="description" required>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                @enderror
                                <img class="file-preview mt-1" src="{{ asset($product->image) }}" height="100">
                            </div>
                        </div>
